package com.android.inputmethod.pinyin.adapters;
...
public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    @StringRes
    private static final int[] TAB_TITLES = new int[]{R.string.first_fragment_label, R.string.second_fragment_label};
